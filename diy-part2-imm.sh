...
git clone --depth 1 --branch main --single-branch --no-checkout https://github.com/xiaorouji/openwrt-passwall/tree/main/luci-app-passwall package/luci-app-passwall
wget https://raw.githubusercontent.com/immortalwrt/luci/master/applications/luci-app-passwall/Makefile -O package/luci-app-passwall/Makefile
